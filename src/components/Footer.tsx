    ...
    <footer className="bg-gradient-to-r from-purple-100 via-purple-50 to-purple-100 border-t border-purple-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center sm:text-left">
          ...
          <div className="col-span-1 sm:col-span-1 grid grid-cols-2 gap-6 sm:gap-8 justify-center">
            {/* Menu Section */}
        ...
        <div className="mt-8 pt-6 sm:mt-12 sm:pt-8 border-t border-purple-200 text-center">
